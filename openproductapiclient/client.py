...
class Client:
    ...
    def get_products(self, **kwargs) -> list:
        ...
        response = self.open_product_api_client.request(
            "get",
            urljoin(base=self.open_product_api_client.base_url, url="producten"),
            params=kwargs,
        )
    ...
    def get_product(self, id, **kwargs):
        ...
        response = self.open_product_api_client.request(
            "get",
            urljoin(base=self.open_product_api_client.base_url, url=f"producten/{id}/"),
            params=kwargs,
        )
    ...
    def add_product(self):
        """
        Adds a product to the products API database.
        """
